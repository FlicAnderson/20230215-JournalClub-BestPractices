...
## 7. Document design and purpose, not mechanics
* share knowledge **(bus factor!)**, lower maintenance time/effort     
* **explain design decisions**  
* **refactor** instead of trying to explain complex code 
* _documentation generators_: docs into code (Try [Sphinx](https://docs.readthedocs.io/en/stable/intro/getting-started-with-sphinx.html)) 
...
## My Opinions 
* well-written, supports aims of the paper  
* **explains SE concepts well** to non-specialists  
* progressing order of recommendations  
* might put off extreme novices/experts? (e.g. optimisation/profiling)  
