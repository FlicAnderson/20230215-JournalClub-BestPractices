...
## TODO: pic of article 
TODO ADD IMAGE of article to slide, show authors, DOI etc.  
...
* published 2014 @ PLOS Biology   
* [Wilson 2006](https://doi-org.ezproxy.is.ed.ac.uk/10.1109/MCSE.2006.122) paper "Software Carpentry: getting scientists to write better code by making them more productive" - prototype ideas expanded on in the 2014 paper  
* Carpentries' reports gathered data from foundational programming/data skills workshop evaluations  
* 
...
* authors' goals in publishing these best practices:  
...
* subsequent paper: Wilson et al. 2017: [Good Enough Practices in Scientific Computing](https://doi.org/10.1371/journal.pcbi.1005510) in PLOS Computational Biology
