...
* [Wilson 2006](https://doi.org/10.1109/MCSE.2006.122) paper "Software Carpentry: getting scientists to write better code by making them more productive" - prototype ideas  
...
* version control **everything you create manually**, _regenerate_ the rest (archive binaries, store metadata)
